    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem Item) {
        switch (Item.getItemId()){
            ...
            case R.id.nav_Results:
                ...
                break;
            case R.id.nav_FavouriteTeam:
                getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, new FavouriteTeamFragment()).commit();
                break;
        }
